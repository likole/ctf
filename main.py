...
class N1ES:
    def __init__(self):
        self.key = "wxy191iss00000000000cute"
        self.gen_subkey()
        print(self.Kn)
...
def test(index):
    ...
    for i in string.printable:
        for j in string.printable:
            flag=flag[:index-1]+i+flag[index:]
            flag=flag[:index+8-1]+j+flag[index+8:]
            cipher=n1es.encrypt(flag)
            if(base64.decodestring("HRlgC2ReHW1/WRk2DikfNBo1dl1XZBJrRR9qECMNOjNHDktBJSxcI1hZIz07YjVx")[index-1]==cipher[index-1] and base64.decodestring("HRlgC2ReHW1/WRk2DikfNBo1dl1XZBJrRR9qECMNOjNHDktBJSxcI1hZIz07YjVx")[index+8-1]==cipher[index+8-1]):
                print(i,j)
...
# for i in range(8):
#     test(i+33)
print base64.b64encode(cipher)=="HRlgC2ReHW1/WRk2DikfNBo1dl1XZBJrRR9qECMNOjNHDktBJSxcI1hZIz07YjVx"  # HRlgC2ReHW1/WRk2DikfNBo1dl1XZBJrRR9qECMNOjNHDktBJSxcI1hZIz07YjVx
